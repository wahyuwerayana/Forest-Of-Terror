...
namespace SlimUI.ModernMenu{
	public class UISettingsManager : MonoBehaviour {
		...
		public GameObject textureultratextLINE;
		...
		public void  Start (){
			...
			if(PlayerPrefs.GetInt("Textures") == 0){
                ...
                textureultratextLINE.gameObject.SetActive(false);

                videoSettingManager.ChangeQualityLevel(0);
            }
                ...
                videoSettingManager.ChangeQualityLevel(1);
            }
                ...
                videoSettingManager.ChangeQualityLevel(2);
            }
			else if (PlayerPrefs.GetInt("Textures") == 3)
			{
                QualitySettings.globalTextureMipmapLimit = 0;
                texturelowtextLINE.gameObject.SetActive(false);
                texturemedtextLINE.gameObject.SetActive(false);
                texturehightextLINE.gameObject.SetActive(false);
                textureultratextLINE.gameObject.SetActive(true);

				videoSettingManager.ChangeQualityLevel(3);
            }
		}
        ...
        public void TexturesUltra()
        {
            PlayerPrefs.SetInt("Textures", 3);
            QualitySettings.globalTextureMipmapLimit = 0;
            texturelowtextLINE.gameObject.SetActive(false);
            texturemedtextLINE.gameObject.SetActive(false);
            texturehightextLINE.gameObject.SetActive(false);
