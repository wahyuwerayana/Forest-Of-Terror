	...
	public override void OnInspectorGUI()
	{
		...
		if (weapon.type == WeaponType.Raycast || weapon.type == WeaponType.Projectile)
		{
			...
			if (showAmmo)
			{
				...
				{
					weapon.unlimitedMagazine = EditorGUILayout.Toggle("Unlimited Magazine", weapon.unlimitedMagazine);
					weapon.ammoCapacity = EditorGUILayout.IntField("Ammo Capacity", weapon.ammoCapacity);
					weapon.reservedAmmo = EditorGUILayout.IntField("Reserved Ammo", weapon.reservedAmmo);
