...
public class Projectile : MonoBehaviour
{
	...
	void Hit(Collision col)
	{
		...
		{
				Health healthScript = col.collider.gameObject.GetComponentInParent<Health>();
				if(healthScript != null && !healthScript.gameObject.CompareTag("Player")) healthScript.ChangeHealth(-damage);
